...
function CartItem(props) {
  ...
  return (
    <div className="cart__item">
      ...
      <p className="cart__item-price">{`${props.product.discount ? Math.round(props.product.price * (1 - (props.product.discount / 100))) * productQ : props.product.price * productQ} ₽`}</p>
